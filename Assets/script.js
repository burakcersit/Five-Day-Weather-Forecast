...
var date = moment().format('MMMM Do YYYY, h:mm:ss a'); //curent time
var key = "7eb77816dcc99ae2a3625aa6fdd7fd5c" //Api Key
...
function getInfo() {
    ...
    localStorage.removeItem('history'); //clean storage when refresh the page (2 times)
}
